...
namespace ChatBot.Common.EventBus
{
    public class CorrelationContext : ICorrelationContext
    {
        ...
        private CorrelationContext(Guid id, string resource)
        {
            Id = id;
            Resource = resource;
        }
        ...
        private CorrelationContext(Guid id, Guid userId, Guid resourceId, string traceId, string spanContext,
            string connectionId, string name, string origin, string culture, string resource, int retries)
        {
            Id = id;
            UserId = userId;
        ...
        public static ICorrelationContext From(Guid id, string resource) => new CorrelationContext(id, resource);
        ...
        public static ICorrelationContext Create<T>(Guid id, Guid userId, Guid resourceId, string origin,
            ...
            => new CorrelationContext(id, userId, resourceId, traceId, spanContext, connectionId, typeof(T).Name, origin, culture,
                resource, 0);
